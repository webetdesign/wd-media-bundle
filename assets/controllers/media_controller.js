  ...
  updateMedia(media) {
    ...
    if (media === null) {
      ...
      if (this.hasBtnEditTarget) {
        this.btnEditTarget.classList.add('d-none')
      }
      if (this.hasBtnDeleteTarget) {
        this.btnDeleteTarget.classList.add('d-none')
      }
      ...
      if (this.hasBtnEditTarget) {
        this.btnEditTarget.classList.remove('d-none')
      }
      if (this.hasBtnDeleteTarget) {
        this.btnDeleteTarget.classList.remove('d-none')
      }
